        ...
        <el-row v-if="comment.showReplyInput" style="padding: 10px 0;">
          <el-col :offset="2" :span="22">
            <div :style="{ backgroundColor: bgColor, height: '110px', borderColor: '#007bff' }"
                 class="parent-comment">
                            <textarea v-model="replyContent" :placeholder="replyText"
                                      class="comment-parent-input"></textarea>
              <div>
                <span class="comment-input-number">{{ replyContent.length }} / 300</span>
                <el-button class="comment-clike"
                           size="mini" style="background-color: #007bff;user-select: none;" type="primary"
                           @click="submitReply(comment)">评论
                </el-button>
              </div>
            </div>
          </el-col>
          ...
          <el-row>
            <el-col :offset="2" :span="22">
              <el-row style="display: flex; align-items: center; flex-wrap: wrap;">
                <el-avatar :src="commentChild.userAvatar" size="small"
                ...
                <el-avatar v-if="commentChild.replierName != null" :src="commentChild.replierAvatar"
                           size="small" style="margin-right: 5px;"></el-avatar>
                  ...
                  <div :style="{ backgroundColor: bgColor, height: '110px', borderColor: '#007bff' }"
                    ...
                    <div>
                                            <span class="comment-input-number">{{ replyChildContent.length }} /
                                                300</span>
                      <el-button class="comment-clike"
                                 size="mini" style="background-color: #007bff;" type="primary"
