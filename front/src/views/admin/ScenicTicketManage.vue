  ...
  <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
    <el-row style="padding: 10px;margin: 0 5px;">
      <el-row>
        ...
        <el-input v-model="scenicTicketQueryDto.detail" clearable
                  placeholder="门票介绍" size="small" style="width: 188px;margin-left: 5px;margin-right: 6px;" @clear="handleFilterClear">
