<template>
  <div class="menu-container">
    ...
    <!-- 个人中心 -->
    <el-dialog :show-close="false" :visible.sync="dialogOperation" width="26%">
      ...
      <el-row style="padding: 10px 20px 20px 20px;">
        ...
        <el-row>
          ...
          <input v-model="userInfo.name" class="input-title" placeholder="用户名">
        </el-row>
        <el-row>
          <p style="font-size: 12px;padding: 3px 0;">
            <span class="modelName">*用户邮箱</span>
          </p>
          <input v-model="userInfo.email" class="input-title" placeholder="用户邮箱">
        </el-row>
      </el-row>
