          ...
          <div v-else>
            <el-carousel height="450px">
              <el-carousel-item v-for="(item, index) in scenicLineList" :key="index">
                <img :src="item.cover" style="border-radius: 5px;height: 100%;width: 100%;" alt="" srcset="">
          ...
          <div>
            ...
            <div class="rating-item" v-for="(rating, index) in scenicRatingList" :key="index">
              <div>
                ...
                <div class="score">
                  <el-rate v-model="rating.score" disabled show-score text-color="#ff9900" score-template="{value}分">
                  </el-rate>
                </div>
                <div class="time">
      ...
      <div style="padding:0 20px;">
        <el-row>
          ...
          <div>
            ...
            <div>
              <p>*购票数量</p>
              <el-input-number v-model="data.buyNumber" :min="1" :max="ticket.number" label="描述文字"></el-input-number>
            </div>
