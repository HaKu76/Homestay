  ...
  <div class="container">
    <div class="item">
      ...
      <div style="margin-top: 20px;">
        ...
        <span v-else class="cannel-save-btn" @click="saveOperation"><i class="el-icon-star-on"></i>取消收藏</span>
      </div>
    </div>
    <div>
          ...
          <div>
            ...
            <div v-for="(rating, index) in scenicRatingList" :key="index" class="rating-item">
              <div>
                ...
                <div class="score">
                  <el-rate v-model="rating.score" disabled score-template="{value}分" show-score
                           text-color="#ff9900">
                  </el-rate>
                </div>
                <div class="time">
